    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.datos-cajas.update", [$datosCaja->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="proceso">{{ trans('cruds.datosCaja.fields.proceso') }}</label>
                            <input class="form-control" type="text" name="proceso" id="proceso" value="{{ old('proceso', $datosCaja->proceso) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="fecha_produccion" id="fecha_produccion" value="{{ old('fecha_produccion', $datosCaja->fecha_produccion) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="turno" id="turno" value="{{ old('turno', $datosCaja->turno) }}" required>
                            @if($errors->has('turno'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('turno') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cod_linea" id="cod_linea" value="{{ old('cod_linea', $datosCaja->cod_linea) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cat" id="cat" value="{{ old('cat', $datosCaja->cat) }}">
                            @if($errors->has('cat'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cat') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="variedad_real" id="variedad_real" value="{{ old('variedad_real', $datosCaja->variedad_real) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="variedad_timbrada" id="variedad_timbrada" value="{{ old('variedad_timbrada', $datosCaja->variedad_timbrada) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="salida" id="salida" value="{{ old('salida', $datosCaja->salida) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="marca" id="marca" value="{{ old('marca', $datosCaja->marca) }}">
                            @if($errors->has('marca'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('marca') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="productor_real" id="productor_real" value="{{ old('productor_real', $datosCaja->productor_real) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="especie" id="especie" value="{{ old('especie', $datosCaja->especie) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cod_caja" id="cod_caja" value="{{ old('cod_caja', $datosCaja->cod_caja) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cod_confeccion" id="cod_confeccion" value="{{ old('cod_confeccion', $datosCaja->cod_confeccion) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="calibre_timbrado" id="calibre_timbrado" value="{{ old('calibre_timbrado', $datosCaja->calibre_timbrado) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="peso_timbrado" id="peso_timbrado" value="{{ old('peso_timbrado', $datosCaja->peso_timbrado) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="lote" id="lote" value="{{ old('lote', $datosCaja->lote) }}">
                            @if($errors->has('lote'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('lote') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nuevo_lote" id="nuevo_lote" value="{{ old('nuevo_lote', $datosCaja->nuevo_lote) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="codigo_qr" id="codigo_qr" value="{{ old('codigo_qr', $datosCaja->codigo_qr) }}">
