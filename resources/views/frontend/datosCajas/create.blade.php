    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.datos-cajas.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="proceso">{{ trans('cruds.datosCaja.fields.proceso') }}</label>
                            <input class="form-control" type="text" name="proceso" id="proceso" value="{{ old('proceso', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="fecha_produccion" id="fecha_produccion" value="{{ old('fecha_produccion') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="turno" id="turno" value="{{ old('turno', '') }}" required>
                            @if($errors->has('turno'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('turno') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cod_linea" id="cod_linea" value="{{ old('cod_linea', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cat" id="cat" value="{{ old('cat', '') }}">
                            @if($errors->has('cat'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('cat') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="variedad_real" id="variedad_real" value="{{ old('variedad_real', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="variedad_timbrada" id="variedad_timbrada" value="{{ old('variedad_timbrada', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="salida" id="salida" value="{{ old('salida', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="marca" id="marca" value="{{ old('marca', '') }}">
                            @if($errors->has('marca'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('marca') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="productor_real" id="productor_real" value="{{ old('productor_real', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="especie" id="especie" value="{{ old('especie', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cod_caja" id="cod_caja" value="{{ old('cod_caja', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cod_confeccion" id="cod_confeccion" value="{{ old('cod_confeccion', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="calibre_timbrado" id="calibre_timbrado" value="{{ old('calibre_timbrado', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="peso_timbrado" id="peso_timbrado" value="{{ old('peso_timbrado', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="lote" id="lote" value="{{ old('lote', '') }}">
                            @if($errors->has('lote'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('lote') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nuevo_lote" id="nuevo_lote" value="{{ old('nuevo_lote', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="codigo_qr" id="codigo_qr" value="{{ old('codigo_qr', '') }}">
