    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.turnos.update", [$turno->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="nombre">{{ trans('cruds.turno.fields.nombre') }}</label>
                            <input class="form-control" type="text" name="nombre" id="nombre" value="{{ old('nombre', $turno->nombre) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="hora_inicio" id="hora_inicio" value="{{ old('hora_inicio', $turno->hora_inicio) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="hora_fin" id="hora_fin" value="{{ old('hora_fin', $turno->hora_fin) }}" required>
