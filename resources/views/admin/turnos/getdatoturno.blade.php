    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.turnos.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('hora_inicio') ? 'is-invalid' : '' }}" type="text" name="hora_inicio" id="hora_inicio" value="{{ old('hora_inicio') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('hora_fin') ? 'is-invalid' : '' }}" type="text" name="hora_fin" id="hora_fin" value="{{ old('hora_fin') }}" required>
