...
<table width="600" cellpadding="0" cellspacing="0" role="presentation"
    style="width:600px;border-collapse:collapse;background-color:#ffffff;border-radius:12px;box-shadow:0 4px 14px rgba(0,0,0,0.08);font-family:'Cabin', Arial, Helvetica, sans-serif;color:#333333;">
    <tr>
            ...
            <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        @else
                            <div style="width:150px;height:150px;margin:0 auto;padding:10px;border:#389542 solid 1px;border-radius:12px">
                                QR no disponible
                            </div>
                        @endif
