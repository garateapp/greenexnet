        ...
        <div style="margin-bottom: 10px;" class="row">
            <div class="col-lg-12">
                ...
                @include('csvImport.modal', [
                    'model' => 'Proceso',
                    'route' => 'admin.procesos.parseCsvImport',
                ])
            </div>
        </div>
    @endcan
        ...
        $(function() {
            ...
            let dtOverrideGlobals = {
                ...
                columns: [{
                    ...
                    {
                        data: 'precio_comercial',
                        name: 'precio_comercial'
                    },
                    {
                        data: 'total_comercial',
                        name: 'total_comercial'
                    },
                    {
                        data: 'costo_comercial',
            ...
            $('#deleteAllButton').on('click', function() {
                if (confirm('{{ trans('global.areYouSure') }}')) {
                    if (confirm('Segura.....???')) {
                        if (confirm('Segurisima.....???')) {
                            if (confirm('No podrás deshacer esta acción....., Segura???')) {
                                if (confirm('bueno yo te advertí, Segura???')) {
                                    $.ajax({
                                        headers: {
                                            'x-csrf-token': _token
                                        },
