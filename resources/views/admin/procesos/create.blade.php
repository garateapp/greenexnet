...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.proceso.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.procesos.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('fecha_proceso') ? 'is-invalid' : '' }}" type="text" name="fecha_proceso" id="fecha_proceso" value="{{ old('fecha_proceso') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('calibre') ? 'is-invalid' : '' }}" type="text" name="calibre" id="calibre" value="{{ old('calibre', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('etd_week') ? 'is-invalid' : '' }}" type="number" name="etd_week" id="etd_week" value="{{ old('etd_week', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('eta_week') ? 'is-invalid' : '' }}" type="number" name="eta_week" id="eta_week" value="{{ old('eta_week', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('resultado_kilo') ? 'is-invalid' : '' }}" type="text" name="resultado_kilo" id="resultado_kilo" value="{{ old('resultado_kilo', '0') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('resultado_total') ? 'is-invalid' : '' }}" type="number" name="resultado_total" id="resultado_total" value="{{ old('resultado_total', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('precio_comercial') ? 'is-invalid' : '' }}" type="number" name="precio_comercial" id="precio_comercial" value="{{ old('precio_comercial', '0') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_comercial') ? 'is-invalid' : '' }}" type="number" name="total_comercial" id="total_comercial" value="{{ old('total_comercial', '0') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('costo_comercial') ? 'is-invalid' : '' }}" type="number" name="costo_comercial" id="costo_comercial" value="{{ old('costo_comercial', '0') }}" step="0.01">
