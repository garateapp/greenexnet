...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.datosCaja.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.datos-cajas.update", [$datosCaja->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="proceso">{{ trans('cruds.datosCaja.fields.proceso') }}</label>
                <input class="form-control {{ $errors->has('proceso') ? 'is-invalid' : '' }}" type="text" name="proceso" id="proceso" value="{{ old('proceso', $datosCaja->proceso) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('fecha_produccion') ? 'is-invalid' : '' }}" type="text" name="fecha_produccion" id="fecha_produccion" value="{{ old('fecha_produccion', $datosCaja->fecha_produccion) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('turno') ? 'is-invalid' : '' }}" type="text" name="turno" id="turno" value="{{ old('turno', $datosCaja->turno) }}" required>
                @if($errors->has('turno'))
                    <div class="invalid-feedback">
                        {{ $errors->first('turno') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cod_linea') ? 'is-invalid' : '' }}" type="text" name="cod_linea" id="cod_linea" value="{{ old('cod_linea', $datosCaja->cod_linea) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cat') ? 'is-invalid' : '' }}" type="text" name="cat" id="cat" value="{{ old('cat', $datosCaja->cat) }}">
                @if($errors->has('cat'))
                    <div class="invalid-feedback">
                        {{ $errors->first('cat') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('variedad_real') ? 'is-invalid' : '' }}" type="text" name="variedad_real" id="variedad_real" value="{{ old('variedad_real', $datosCaja->variedad_real) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('variedad_timbrada') ? 'is-invalid' : '' }}" type="text" name="variedad_timbrada" id="variedad_timbrada" value="{{ old('variedad_timbrada', $datosCaja->variedad_timbrada) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('salida') ? 'is-invalid' : '' }}" type="text" name="salida" id="salida" value="{{ old('salida', $datosCaja->salida) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('marca') ? 'is-invalid' : '' }}" type="text" name="marca" id="marca" value="{{ old('marca', $datosCaja->marca) }}">
                @if($errors->has('marca'))
                    <div class="invalid-feedback">
                        {{ $errors->first('marca') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('productor_real') ? 'is-invalid' : '' }}" type="text" name="productor_real" id="productor_real" value="{{ old('productor_real', $datosCaja->productor_real) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('especie') ? 'is-invalid' : '' }}" type="text" name="especie" id="especie" value="{{ old('especie', $datosCaja->especie) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cod_caja') ? 'is-invalid' : '' }}" type="text" name="cod_caja" id="cod_caja" value="{{ old('cod_caja', $datosCaja->cod_caja) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cod_confeccion') ? 'is-invalid' : '' }}" type="text" name="cod_confeccion" id="cod_confeccion" value="{{ old('cod_confeccion', $datosCaja->cod_confeccion) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('calibre_timbrado') ? 'is-invalid' : '' }}" type="text" name="calibre_timbrado" id="calibre_timbrado" value="{{ old('calibre_timbrado', $datosCaja->calibre_timbrado) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('peso_timbrado') ? 'is-invalid' : '' }}" type="text" name="peso_timbrado" id="peso_timbrado" value="{{ old('peso_timbrado', $datosCaja->peso_timbrado) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lote') ? 'is-invalid' : '' }}" type="text" name="lote" id="lote" value="{{ old('lote', $datosCaja->lote) }}">
                @if($errors->has('lote'))
                    <div class="invalid-feedback">
                        {{ $errors->first('lote') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nuevo_lote') ? 'is-invalid' : '' }}" type="text" name="nuevo_lote" id="nuevo_lote" value="{{ old('nuevo_lote', $datosCaja->nuevo_lote) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('codigo_qr') ? 'is-invalid' : '' }}" type="text" name="codigo_qr" id="codigo_qr" value="{{ old('codigo_qr', $datosCaja->codigo_qr) }}">
