...
@section('content')
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('cruds.instructivoEmbarque.title_singular') }}
        </div>

        <div class="card-body">

            <form method="POST" action="{{ route('admin.instructivo-embarques.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <!-- Column 1 -->
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('instructivo') ? 'is-invalid' : '' }}" type="text"
                                name="instructivo" id="instructivo" value="{{ old('instructivo', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2 {{ $errors->has('agente_aduana') ? 'is-invalid' : '' }}"
                                ...
                                @foreach ($agente_aduanas as $id => $entry)
                                    <option value="{{ $id }}"
                                        {{ old('agente_aduana_id') == $id ? 'selected' : '' }}>{{ $entry }}
                                    </option>
                                @endforeach
                            </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group" id="naviera">
                                    ...
                                    <select class="form-control select2 {{ $errors->has('naviera') ? 'is-invalid' : '' }}"
                                        ...
                                        @foreach ($navieras as $id => $entry)
                                            <option value="{{ $id }}"
                                                {{ old('naviera_id') == $id ? 'selected' : '' }}>{{ $entry }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group" id="numero_booking">
                                    ...
                                    <input class="form-control {{ $errors->has('num_booking') ? 'is-invalid' : '' }}"
                                        ...
                                        value="{{ old('num_booking', '') }}" required>
                                ...
                                <div class="form-group" id="navediv">
                                    ...
                                    <input class="form-control {{ $errors->has('nave') ? 'is-invalid' : '' }}"
                                        type="text" name="nave" id="nave" value="{{ old('nave', '') }}">
                                    @if ($errors->has('nave'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('nave') }}
                                        </div>
                                ...
                                <div class="form-group" id="cut_off_div">
                                    ...
                                    <input class="form-control date {{ $errors->has('cut_off') ? 'is-invalid' : '' }}"
                                        type="text" name="cut_off" id="cut_off" value="{{ old('cut_off', '') }}"
                                        required>
                                ...
                                <div class="form-group" id="stacking_ini_div">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('stacking_ini') }}" required>
                                ...
                                <div id="divaerea-left">
                                    <div class="form-group" id="awb_div">
                                        ...
                                        <input class="form-control {{ $errors->has('awb') ? 'is-invalid' : '' }}"
                                            type="text" name="awb" id="awb" value="{{ old('awb', '') }}">
                                        @if ($errors->has('awb'))
                                            <div class="invalid-feedback">
                                                {{ $errors->first('awb') }}
                                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control date {{ $errors->has('etd') ? 'is-invalid' : '' }}"
                                        type="text" name="etd" id="etd" value="{{ old('etd') }}">
                                    @if ($errors->has('etd'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('etd') }}
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control date {{ $errors->has('eta') ? 'is-invalid' : '' }}"
                                        type="text" name="eta" id="eta" value="{{ old('eta') }}">
                                    @if ($errors->has('eta'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('eta') }}
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        @foreach ($puerto_embarques as $id => $entry)
                                            <option value="{{ $id }}"
                                                {{ old('puerto_embarque_id') == $id ? 'selected' : '' }}>
                                                {{ $entry }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        @foreach ($puerto_destinos as $id => $entry)
                                            <option value="{{ $id }}"
                                                {{ old('puerto_destino_id') == $id ? 'selected' : '' }}>
                                                {{ $entry }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        @foreach ($puerto_descargas as $id => $entry)
                                            <option value="{{ $id }}"
                                                {{ old('puerto_descarga_id') == $id ? 'selected' : '' }}>
                                                {{ $entry }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        @foreach ($pais_embarque as $id => $entry)
                                            <option value="{{ $id }}"
                                                {{ old('pais_embarque_id') == $id ? 'selected' : '' }}>
                                                {{ $entry }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        @foreach ($pais_destino as $id => $entry)
                                            <option value="{{ $id }}"
                                                {{ old('pais_destino_id') == $id ? 'selected' : '' }}>
                                                {{ $entry }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group" id="contenedor_container">
                                    ...
                                    <input class="form-control {{ $errors->has('num_contenedor') ? 'is-invalid' : '' }}"
                                        ...
                                        value="{{ old('num_contenedor', '') }}" required>
                                ...
                                <div class="form-group" id="ventilacion_div">
                                    ...
                                    <input class="form-control {{ $errors->has('ventilacion') ? 'is-invalid' : '' }}"
                                        ...
                                        value="{{ old('ventilacion', '0 CBM') }}" required>
                                ...
                                <div class="form-group" id="quest_div">
                                    ...
                                    <input class="form-control {{ $errors->has('quest') ? 'is-invalid' : '' }}"
                                        type="text" name="quest" id="quest" value="{{ old('quest', '') }}">
                                    @if ($errors->has('quest'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('quest') }}
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{ $errors->has('temperatura') ? 'is-invalid' : '' }}"
                                        ...
                                        value="{{ old('temperatura', '') }}" step="0.01">
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('empresa_transportista', '') }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{ $errors->has('ppu') ? 'is-invalid' : '' }}"
                                        type="text" name="ppu" id="ppu" value="{{ old('ppu', '') }}">
                                    @if ($errors->has('ppu'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('ppu') }}
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        @foreach ($planta_cargas as $id => $entry)
                                            <option value="{{ $id }}"
                                                {{ old('planta_carga_id') == $id ? 'selected' : '' }}>
                                                {{ $entry }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('guia_despacho_dirigida', '') }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('planilla_sag_dirigida', '') }}" required>
                                ...
                                <div class="aereo_terrestre_div">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control {{ $errors->has('dus') ? 'is-invalid' : '' }}"
                                            type="text" name="dus" id="dus" value="{{ old('dus', '') }}"
                                            required>
                                        @if ($errors->has('dus'))
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control {{ $errors->has('sps') ? 'is-invalid' : '' }}"
                                            type="text" name="sps" id="sps" value="{{ old('sps', '') }}"
                                            required>
                                        @if ($errors->has('sps'))
                                            <div class="invalid-feedback">
                                                {{ $errors->first('sps') }}
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{ $errors->has('num_po') ? 'is-invalid' : '' }}"
                                        type="text" name="num_po" id="num_po" value="{{ old('num_po', '') }}"
                                        required>
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        @foreach ($forma_de_pagos as $id => $entry)
                                            <option value="{{ $id }}"
                                                {{ old('forma_de_pago_id') == $id ? 'selected' : '' }}>
                                                {{ $entry }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        @foreach ($modalidad_de_ventas as $id => $entry)
                                            <option value="{{ $id }}"
                                                {{ old('modalidad_de_venta_id') == $id ? 'selected' : '' }}>
                                                {{ $entry }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        @foreach ($emision_de_bls as $id => $entry)
                                            <option value="{{ $id }}"
                                                {{ old('emision_de_bl_id') == $id ? 'selected' : '' }}>
                                                {{ $entry }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        @foreach ($tipo_de_fletes as $id => $entry)
                                            <option value="{{ $id }}"
                                                {{ old('tipo_de_flete_id') == $id ? 'selected' : '' }}>
                                                {{ $entry }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select
                                        ...
                                        @foreach ($clausula_de_ventas as $id => $entry)
                                            <option value="{{ $id }}"
                                                {{ old('clausula_de_venta_id') == $id ? 'selected' : '' }}>
                                                {{ $entry }}
                                            </option>
                                        @endforeach
                                    </select>
