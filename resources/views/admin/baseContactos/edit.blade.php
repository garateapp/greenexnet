...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.baseContacto.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.base-contactos.update", [$baseContacto->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('cliente') ? 'is-invalid' : '' }}" name="cliente_id" id="cliente_id" required>
                    @foreach($clientes as $id => $entry)
                        <option value="{{ $id }}" {{ (old('cliente_id') ? old('cliente_id') : $baseContacto->cliente->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('tipo_transporte') ? 'is-invalid' : '' }}" name="tipo_transporte" id="tipo_transporte">
                    ...
                    @foreach(App\Models\BaseContacto::TIPO_TRANSPORTE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('tipo_transporte', $baseContacto->tipo_transporte) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rut_recibidor') ? 'is-invalid' : '' }}" type="text" name="rut_recibidor" id="rut_recibidor" value="{{ old('rut_recibidor', $baseContacto->rut_recibidor) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('direccion') ? 'is-invalid' : '' }}" type="text" name="direccion" id="direccion" value="{{ old('direccion', $baseContacto->direccion) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contacto') ? 'is-invalid' : '' }}" type="text" name="contacto" id="contacto" value="{{ old('contacto', $baseContacto->contacto) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telefono') ? 'is-invalid' : '' }}" type="text" name="telefono" id="telefono" value="{{ old('telefono', $baseContacto->telefono) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fax') ? 'is-invalid' : '' }}" type="text" name="fax" id="fax" value="{{ old('fax', $baseContacto->fax) }}">
                @if($errors->has('fax'))
                    <div class="invalid-feedback">
                        {{ $errors->first('fax') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $baseContacto->email) }}">
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('notify') ? 'is-invalid' : '' }}" type="text" name="notify" id="notify" value="{{ old('notify', $baseContacto->notify) }}">
