                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="card text-white bg-info">
                            <div class="card-body pb-0 d-flex justify-content-between align-items-start">
                                <div>
                                    <div class="text-center">Total Pallets Sin Armar</div>
                                    <div class="fs-4 fw-semibold text-center">
                                        <i class="fas fa-boxes" style="color: #FFFFFF; font-size: x-large;"></i>
                                        <span class="fs-6 fw-normal text-center" id="totalPalletsSinArmar"
            ...
            $(document).ready(function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        antiguedad = data.antiguedad;
                            ...
                            const fecha = new Date(antiguedad.fecha_minima);
                        ...
                        $("#antiguedadTransito").html(`${dia}-${mes}-${anio}` + " - " + antiguedad
                        .cantidad+' Cajas');
                        // bodega.forEach(
                        //     function(value) {
                        ...
                        table = $('#TransitoTable').DataTable({
                            ...
                            createdRow: function(row, data) {
                                calibres.forEach(calibre => {
                                    ...
                                    if (palletsValue > 1) {
                                        TotalPalletsxArmar += Math.trunc(palletsValue);
                                ...
                                $("#totalPalletsSinArmar").html(TotalPalletsxArmar);
                            },
                        });
                ...
                $('#TransitoTable').on('click', 'td', function() {
                    ...
                    if (columnIdx >= 5) {
                        ...
                        var columnHeader = $('#TransitoTable thead tr:eq(1) th').eq(columnIdx).text().replace(
                            / Cajas| Pallets/g, '');
