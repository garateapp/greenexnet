...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.embalaje.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.embalajes.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label class="required" for="c_embalaje">{{ trans('cruds.embalaje.fields.c_embalaje') }}</label>
                <input class="form-control {{ $errors->has('c_embalaje') ? 'is-invalid' : '' }}" type="text" name="c_embalaje" id="c_embalaje" value="{{ old('c_embalaje', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kgxcaja') ? 'is-invalid' : '' }}" type="number" name="kgxcaja" id="kgxcaja" value="{{ old('kgxcaja', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cajaxpallet') ? 'is-invalid' : '' }}" type="text" name="cajaxpallet" id="cajaxpallet" value="{{ old('cajaxpallet', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('altura_pallet') ? 'is-invalid' : '' }}" type="number" name="altura_pallet" id="altura_pallet" value="{{ old('altura_pallet', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('tipo_embarque') ? 'is-invalid' : '' }}" name="tipo_embarque" id="tipo_embarque">
                    ...
                    @foreach(App\Models\Embalaje::TIPO_EMBARQUE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('tipo_embarque', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('caja') ? 'is-invalid' : '' }}" type="text" name="caja" id="caja" value="{{ old('caja', '') }}" required>
                @if($errors->has('caja'))
                    <div class="invalid-feedback">
                        {{ $errors->first('caja') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cajasxlinea') ? 'is-invalid' : '' }}" type="text" name="cajasxlinea" id="cajasxlinea" value="{{ old('cajasxlinea', '') }}" required>
              ...
              <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lineasxpallet') ? 'is-invalid' : '' }}" type="text" name="lineasxpallet" id="lineasxpallet" value="{{ old('lineasxpallet', '') }}" required>
