...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Locacion">
            <thead>
                <tr>
                    <th width="10">
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.locacions.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'nombre', name: 'nombre' },
{ data: 'area_nombre', name: 'area.nombre' },
{ data: 'cantidad_personal', name: 'cantidad_personal' },
{ data: 'estado_nombre', name: 'estado.nombre' },
{ data: 'locacion_padre_nombre', name: 'locacion_padre.nombre' },
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Locacion').DataTable(dtOverrideGlobals);
