...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.embarcador.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.embarcadors.update", [$embarcador->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="codigo">{{ trans('cruds.embarcador.fields.codigo') }}</label>
                <input class="form-control {{ $errors->has('codigo') ? 'is-invalid' : '' }}" type="text" name="codigo" id="codigo" value="{{ old('codigo', $embarcador->codigo) }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('via') ? 'is-invalid' : '' }}" name="via" id="via" required>
                    ...
                    @foreach(App\Models\Embarcador::VIA_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('via', $embarcador->via) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('via'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nombre') ? 'is-invalid' : '' }}" type="text" name="nombre" id="nombre" value="{{ old('nombre', $embarcador->nombre) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rut') ? 'is-invalid' : '' }}" type="text" name="rut" id="rut" value="{{ old('rut', $embarcador->rut) }}">
                @if($errors->has('rut'))
                    <div class="invalid-feedback">
                        {{ $errors->first('rut') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('attn') ? 'is-invalid' : '' }}" type="text" name="attn" id="attn" value="{{ old('attn', $embarcador->attn) }}" required>
                @if($errors->has('attn'))
                    <div class="invalid-feedback">
                        {{ $errors->first('attn') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="text" name="email" id="email" value="{{ old('email', $embarcador->email) }}">
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telefono') ? 'is-invalid' : '' }}" type="text" name="telefono" id="telefono" value="{{ old('telefono', $embarcador->telefono) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('cc') ? 'is-invalid' : '' }}" name="cc" id="cc">{{ old('cc', $embarcador->cc) }}</textarea>
                @if($errors->has('cc'))
                    <div class="invalid-feedback">
                        {{ $errors->first('cc') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('p_sag_dir') ? 'is-invalid' : '' }}" type="text" name="p_sag_dir" id="p_sag_dir" value="{{ old('p_sag_dir', $embarcador->p_sag_dir) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('g_dir_a') ? 'is-invalid' : '' }}" type="text" name="g_dir_a" id="g_dir_a" value="{{ old('g_dir_a', $embarcador->g_dir_a) }}" required>
