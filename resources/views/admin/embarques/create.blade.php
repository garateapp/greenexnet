...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.embarque.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.embarques.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('temporada') ? 'is-invalid' : '' }}" name="temporada" id="temporada">
                    ...
                    @foreach(App\Models\Embarque::TEMPORADA_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('temporada', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('num_embarque') ? 'is-invalid' : '' }}" type="text" name="num_embarque" id="num_embarque" value="{{ old('num_embarque', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('id_cliente') ? 'is-invalid' : '' }}" type="text" name="id_cliente" id="id_cliente" value="{{ old('id_cliente', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('n_cliente') ? 'is-invalid' : '' }}" type="text" name="n_cliente" id="n_cliente" value="{{ old('n_cliente', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('planta_carga') ? 'is-invalid' : '' }}" type="text" name="planta_carga" id="planta_carga" value="{{ old('planta_carga', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('n_naviera') ? 'is-invalid' : '' }}" type="text" name="n_naviera" id="n_naviera" value="{{ old('n_naviera', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nave') ? 'is-invalid' : '' }}" type="text" name="nave" id="nave" value="{{ old('nave', '') }}">
                @if($errors->has('nave'))
                    <div class="invalid-feedback">
                        {{ $errors->first('nave') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('num_contenedor') ? 'is-invalid' : '' }}" type="text" name="num_contenedor" id="num_contenedor" value="{{ old('num_contenedor', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('variedad') ? 'is-invalid' : '' }}" type="text" name="variedad" id="variedad" value="{{ old('variedad', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('embalajes') ? 'is-invalid' : '' }}" type="text" name="embalajes" id="embalajes" value="{{ old('embalajes', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('etiqueta') ? 'is-invalid' : '' }}" type="text" name="etiqueta" id="etiqueta" value="{{ old('etiqueta', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cajas') ? 'is-invalid' : '' }}" type="text" name="cajas" id="cajas" value="{{ old('cajas', '') }}">
                @if($errors->has('cajas'))
                    <div class="invalid-feedback">
                        {{ $errors->first('cajas') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('peso_neto') ? 'is-invalid' : '' }}" type="text" name="peso_neto" id="peso_neto" value="{{ old('peso_neto', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('puerto_embarque') ? 'is-invalid' : '' }}" type="text" name="puerto_embarque" id="puerto_embarque" value="{{ old('puerto_embarque', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('pais_destino') ? 'is-invalid' : '' }}" type="text" name="pais_destino" id="pais_destino" value="{{ old('pais_destino', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('puerto_destino') ? 'is-invalid' : '' }}" type="text" name="puerto_destino" id="puerto_destino" value="{{ old('puerto_destino', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('mercado') ? 'is-invalid' : '' }}" type="text" name="mercado" id="mercado" value="{{ old('mercado', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('etd_estimado') ? 'is-invalid' : '' }}" type="text" name="etd_estimado" id="etd_estimado" value="{{ old('etd_estimado') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('eta_estimado') ? 'is-invalid' : '' }}" type="text" name="eta_estimado" id="eta_estimado" value="{{ old('eta_estimado', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('fecha_zarpe_real') ? 'is-invalid' : '' }}" type="text" name="fecha_zarpe_real" id="fecha_zarpe_real" value="{{ old('fecha_zarpe_real') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('fecha_arribo_real') ? 'is-invalid' : '' }}" type="text" name="fecha_arribo_real" id="fecha_arribo_real" value="{{ old('fecha_arribo_real') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dias_transito_real') ? 'is-invalid' : '' }}" type="number" name="dias_transito_real" id="dias_transito_real" value="{{ old('dias_transito_real', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('descargado') ? 'is-invalid' : '' }}" type="text" name="descargado" id="descargado" value="{{ old('descargado', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('retirado_full') ? 'is-invalid' : '' }}" type="text" name="retirado_full" id="retirado_full" value="{{ old('retirado_full', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('devuelto_vacio') ? 'is-invalid' : '' }}" type="text" name="devuelto_vacio" id="devuelto_vacio" value="{{ old('devuelto_vacio', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('notas') ? 'is-invalid' : '' }}" name="notas" id="notas">{{ old('notas') }}</textarea>
                @if($errors->has('notas'))
                    <div class="invalid-feedback">
                        {{ $errors->first('notas') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('calificacion') ? 'is-invalid' : '' }}" type="text" name="calificacion" id="calificacion" value="{{ old('calificacion', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('conexiones') ? 'is-invalid' : '' }}" type="text" name="conexiones" id="conexiones" value="{{ old('conexiones', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('con_fecha_hora') ? 'is-invalid' : '' }}" type="text" name="con_fecha_hora" id="con_fecha_hora" value="{{ old('con_fecha_hora') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('status_aereo') ? 'is-invalid' : '' }}" name="status_aereo" id="status_aereo">
                    ...
                    @foreach(App\Models\Embarque::STATUS_AEREO_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('status_aereo', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('num_pallets') ? 'is-invalid' : '' }}" type="text" name="num_pallets" id="num_pallets" value="{{ old('num_pallets', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('embalaje_std') ? 'is-invalid' : '' }}" type="text" name="embalaje_std" id="embalaje_std" value="{{ old('embalaje_std', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('num_orden') ? 'is-invalid' : '' }}" type="text" name="num_orden" id="num_orden" value="{{ old('num_orden', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tipo_especie') ? 'is-invalid' : '' }}" type="text" name="tipo_especie" id="tipo_especie" value="{{ old('tipo_especie', '') }}">
