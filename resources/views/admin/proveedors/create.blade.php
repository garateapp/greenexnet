...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.proveedor.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.proveedors.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cobro') ? 'is-invalid' : '' }}" type="text" name="cobro" id="cobro" value="{{ old('cobro', '') }}" required>
                @if($errors->has('cobro'))
                    <div class="invalid-feedback">
                        {{ $errors->first('cobro') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nombre_simple') ? 'is-invalid' : '' }}" type="text" name="nombre_simple" id="nombre_simple" value="{{ old('nombre_simple', '') }}">
