...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.anticipo.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.anticipos.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('num_docto') ? 'is-invalid' : '' }}" type="number" name="num_docto" id="num_docto" value="{{ old('num_docto', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('fecha_documento') ? 'is-invalid' : '' }}" type="text" name="fecha_documento" id="fecha_documento" value="{{ old('fecha_documento') }}">
