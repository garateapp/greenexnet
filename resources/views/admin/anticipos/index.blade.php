...
@can('anticipo_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            ...
            @include('csvImport.modal', ['model' => 'Anticipo', 'route' => 'admin.anticipos.parseCsvImport'])
        </div>
    </div>
@endcan
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-Anticipo">
            <thead>
                <tr>
                    <th width="10">
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.anticipos.index') }}",
    columns: [
...
{ data: 'num_docto', name: 'num_docto' },
{ data: 'fecha_documento', name: 'fecha_documento' },
{ data: 'tipo_cambio_id', name: 'tipo_cambio_id' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-Anticipo').DataTable(dtOverrideGlobals);
