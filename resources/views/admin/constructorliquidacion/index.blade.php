...
@section('content')
    ...
    <script>
                            ...
                            if (processed === chartContainers.length) {
                                ...
                                $.ajax({
                                    ...
                                    success: function(response_pdf) {
                                        ...
                                        link_pdf.href = window.URL.createObjectURL(
                                            blob_pdf);
                                        link_pdf.download = 'Liquidacion-' +
                                            productor_nombre + '-' + $(
                                                '#temporada')
                                            .val() + '.pdf';
                                        link_pdf.click();
        ...
        let productor_nombre = ''; $('#productor_id').select2(); $('#temporada').select2(); $('#especie_id')
        .select2(); $('#btnPreview').on('click', function() {
