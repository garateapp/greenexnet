    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.liq-cx-cabeceras.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.liqCxCabecera.title_singular') }}
            </a>
            <button class="btn btn-warning" data-toggle="modal" data-target="#csvImportModal">
                {{ trans('global.app_csvImport') }}
            </button>
            @include('csvImport.modal', ['model' => 'LiqCxCabecera', 'route' => 'admin.liq-cx-cabeceras.parseCsvImport'])
        </div>
    </div>
@endcan
<div class="card">
...
{ data: 'nave_nombre', name: 'nave.nombre' },
{ data: 'nave.codigo', name: 'nave.codigo' },
{ data: 'eta', name: 'eta' },
{ data: 'tasa_intercambio', name: 'tasa_intercambio' },
{ data: 'total_costo', name: 'total_costo' },
{ data: 'total_bruto', name: 'total_bruto' },
