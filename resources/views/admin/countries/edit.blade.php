    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.countries.update", [$country->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('codigo_sag') ? 'is-invalid' : '' }}" type="text" name="codigo_sag" id="codigo_sag" value="{{ old('codigo_sag', $country->codigo_sag) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cap') ? 'is-invalid' : '' }}" type="text" name="cap" id="cap" value="{{ old('cap', $country->cap) }}">
                @if($errors->has('cap'))
                    <div class="invalid-feedback">
                        {{ $errors->first('cap') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('codigo_facturacion') ? 'is-invalid' : '' }}" type="text" name="codigo_facturacion" id="codigo_facturacion" value="{{ old('codigo_facturacion', $country->codigo_facturacion) }}">
