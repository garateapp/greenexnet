...
class UsersController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.users.index', compact('estados', 'roles', 'users'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.users.create', compact('estados', 'roles'));
    }
    ...
    public function edit(User $user)
    {
        ...
        return view('frontend.users.edit', compact('estados', 'roles', 'user'));
    }
    ...
    public function show(User $user)
    {
        ...
        $user->load('roles', 'estado', 'userUserAlerts');
