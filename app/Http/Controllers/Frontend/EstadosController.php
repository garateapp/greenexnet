...
class EstadosController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.estados.index', compact('estados'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.estados.create');
    }
    ...
    public function store(StoreEstadoRequest $request)
    {
        ...
        return redirect()->route('frontend.estados.index');
    }
    ...
    public function edit(Estado $estado)
    {
        ...
        return view('frontend.estados.edit', compact('estado'));
    }
    ...
    public function show(Estado $estado)
    {
        ...
        return view('frontend.estados.show', compact('estado'));
    }
